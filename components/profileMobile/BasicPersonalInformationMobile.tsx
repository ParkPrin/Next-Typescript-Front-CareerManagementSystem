...
class BasicPersonalInformationMobile extends React.Component<BasicPersonalInformationPageProps, BasicPersonalInformationState> {
    state = {
        ko_value : "",
        localType: '02',
        localPhone : "",
...
export default withStyles(useStyles)(BasicPersonalInformationMobile)